...
def spirituality():
    label_c=tk.Label(wordsframe,text=random.choice(Sq.foo), font="helvetica 14", wraplength=quoteswidth, justify="center")
    label_c.pack()
...
label_musq.pack()
def after():
    label_musq.config(text=random.choice(Sq.musicquotes))
